...
export const messages = {
  ...
  // --- 0.9.0 ---
  clHeadline0120: {
    en: 'One click, a random deck, straight to the table.',
    es: 'Un clic, un mazo al azar, directo a la mesa.',
    fr: 'Un clic, un deck au hasard, droit à la table.',
    ar: 'نقرة واحدة، مجموعة عشوائية، ومباشرةً إلى الطاولة.',
  },
  clLadderPage: {
    en: 'A ladder you can see',
    es: 'Una clasificación que puedes ver',
    fr: 'Un classement visible',
    ar: 'سُلَّم ترتيب يمكنك رؤيته',
  },
  clLadderPageDesc: {
    en: 'The competitive ladder now has a page of its own, with your standing on it and a way to size up your friends.',
    es: 'La clasificación competitiva ya tiene su propia página, con tu posición y una forma de comparar con tus amigos.',
    fr: 'Le classement compétitif a désormais sa propre page, avec votre position et de quoi vous comparer à vos amis.',
    ar: 'صار لسُلَّم الترتيب التنافسي صفحته الخاصة، تعرض موقعك وتتيح مقارنة أصدقائك.',
  },
  clNewsModal: {
    en: 'The headline strip opens the notes',
    es: 'La tira de titulares abre las notas',
    fr: 'Le bandeau d’actualités ouvre les notes',
    ar: 'شريط العناوين يفتح ملاحظات الإصدار',
  },
  clNewsModalDesc: {
    en: 'Click any headline scrolling across the home page and that release’s notes open in full, rather than the strip being the only thing you ever get to read about it.',
    es: 'Haz clic en cualquier titular que pase por la página de inicio y se abrirán las notas completas de esa versión, en vez de quedarte solo con la tira.',
    fr: 'Cliquez sur n’importe quel titre qui défile sur l’accueil et les notes complètes de cette version s’ouvrent, au lieu que le bandeau soit tout ce que vous puissiez en lire.',
    ar: 'انقر أي عنوان يمرّ في الصفحة الرئيسية لتُفتح ملاحظات ذلك الإصدار كاملة، بدل أن يكون الشريط كل ما يمكنك قراءته عنه.',
  },
  clProfileChip: {
    en: 'Your profile hangs off the account chip',
    es: 'Tu perfil cuelga de la ficha de cuenta',
    fr: 'Votre profil pend à la pastille de compte',
    ar: 'ملفك الشخصي معلّق بشارة الحساب',
  },
  clProfileChipDesc: {
    en: 'On desktop the avatar in the title bar is now the way to your profile, and resting on it previews your name, division and record without going anywhere. Profile has left the left-hand rail, which lists places you go rather than things you are.',
    es: 'En escritorio, el avatar de la barra de título es ahora la vía a tu perfil, y al posarte sobre él ves tu nombre, división y registro sin ir a ningún sitio. Perfil ha salido de la barra lateral, que lista lugares a los que vas, no lo que eres.',
    fr: 'Sur ordinateur, l’avatar de la barre de titre mène désormais à votre profil, et le survoler affiche nom, division et bilan sans changer de page. Profil a quitté le rail de gauche, qui liste des endroits où aller, pas ce que vous êtes.',
    ar: 'على سطح المكتب صارت الصورة الرمزية في شريط العنوان هي الطريق إلى ملفك، ويكفي أن تمرّ فوقها لترى اسمك وقسمك وسجلّك دون الانتقال. وخرج الملف الشخصي من الشريط الجانبي الذي يسرد أماكن تذهب إليها لا صفات تكونها.',
  },
  clChipAlign: {
    en: 'Chips sit straight',
    es: 'Las fichas quedan rectas',
    fr: 'Les pastilles sont d’aplomb',
    ar: 'الشارات صارت مستقيمة',
  },
  clChipAlignDesc: {
    en: 'Several small labels sat a couple of pixels low, or floated clear above the text beside them, because they were hand-built boxes rather than real chips. They are the real ones now, and they line up.',
    es: 'Varias etiquetas pequeñas quedaban un par de píxeles bajas, o flotaban por encima del texto contiguo, porque eran cajas hechas a mano y no fichas de verdad. Ahora son las de verdad y quedan alineadas.',
    fr: 'Plusieurs petits libellés se posaient deux pixels trop bas, ou flottaient au-dessus du texte voisin, parce que c’étaient des boîtes bricolées et non de vraies pastilles. Ce sont désormais les vraies, et elles s’alignent.',
    ar: 'كانت عدة تسميات صغيرة تجلس أخفض ببضع بكسلات، أو تطفو فوق النص المجاور، لأنها صناديق مصنوعة يدويًا لا شارات حقيقية. صارت الآن حقيقية ومصطفّة.',
  },
  clHeadline0110: {
  ...
  clRoulette: {
    en: 'Standard and Commander Roulette',
    es: 'Ruleta Estándar y Commander',
    fr: 'Roulette Standard et Commander',
    ar: 'روليت ستاندرد وكوماندر',
  },
  clRouletteDesc: {
    en: 'Two plates at the top of Play that need nothing from you at all: one click opens the table, seats the opposition, deals every seat a random deck and starts the game. Standard is a 1v1 out of the 60-card pool; Commander is you against four, every seat holding a precon it did not choose.',
    es: 'Dos placas al principio de Jugar que no te piden nada: un clic abre la mesa, sienta a la oposición, reparte un mazo al azar a cada asiento y empieza la partida. Estándar es un 1c1 del grupo de 60 cartas; Commander eres tú contra cuatro, cada asiento con un preconstruido que no eligió.',
    fr: 'Deux plaques en haut de Jouer qui ne vous demandent rien : un clic ouvre la table, installe l’opposition, distribue un deck au hasard à chaque siège et lance la partie. Standard est un 1c1 tiré du pool de 60 cartes ; Commander vous oppose à quatre, chaque siège tenant un précon qu’il n’a pas choisi.',
    ar: 'لوحتان أعلى قسم اللعب لا تطلبان منك شيئًا: نقرة واحدة تفتح الطاولة وتُجلس الخصوم وتوزّع على كل مقعد مجموعة عشوائية وتبدأ المباراة. ستاندرد مبارزة فردية من مجموعات الـ٦٠ بطاقة؛ وكوماندر أنت في مواجهة أربعة، كل مقعد يحمل مجموعة جاهزة لم يخترها.',
  },
  clHomeNews: {
  ...
  brShowMore: { en: 'Load {n} more', es: 'Cargar {n} más', fr: 'Charger {n} de plus', ar: 'تحميل {n} إضافية' },
  brCountAll: { en: '{n} decks', es: '{n} mazos', fr: '{n} decks', ar: '{n} مجموعة' },
  brCountSome: { en: '{n} of {all} decks', es: '{n} de {all} mazos', fr: '{n} decks sur {all}', ar: '{n} من {all} مجموعة' },
  brShowing: { en: 'showing {n}', es: 'mostrando {n}', fr: '{n} affichés', ar: 'عرض {n}' },
  brClear: { en: 'Clear', es: 'Limpiar', fr: 'Effacer', ar: 'مسح' },
  brSource: { en: 'Deck source', es: 'Origen de mazos', fr: 'Source des decks', ar: 'مصدر المجموعات' },
  brSourcePrecon: { en: 'Precons', es: 'Preconstruidos', fr: 'Précons', ar: 'جاهزة' },
  brSourceCommunity: { en: 'Community', es: 'Comunidad', fr: 'Communauté', ar: 'المجتمع' },
  brTitleCommunity: { en: 'Community decks', es: 'Mazos de la comunidad', fr: 'Decks de la communauté', ar: 'مجموعات المجتمع' },
  brLedeCommunity: {
    en: 'Search decks people have published on Archidekt and add one to your library without leaving the app.',
    es: 'Busca mazos publicados en Archidekt y añade uno a tu biblioteca sin salir de la app.',
    fr: 'Cherchez des decks publiés sur Archidekt et ajoutez-en un à votre bibliothèque sans quitter l’app.',
    ar: 'ابحث في المجموعات المنشورة على Archidekt وأضف واحدة إلى مكتبتك دون مغادرة التطبيق.',
  },
  brCommunitySearch: { en: 'Search Archidekt decks, or paste a deck link…', es: 'Busca mazos de Archidekt o pega un enlace…', fr: 'Cherchez des decks Archidekt, ou collez un lien…', ar: 'ابحث في مجموعات Archidekt أو الصق رابطًا…' },
  brCommunityNote: { en: 'Results come from Archidekt', es: 'Resultados de Archidekt', fr: 'Résultats fournis par Archidekt', ar: 'النتائج من Archidekt' },
  brCommunityPrompt: { en: 'Type at least two letters', es: 'Escribe al menos dos letras', fr: 'Tapez au moins deux lettres', ar: 'اكتب حرفين على الأقل' },
  brCommunityFailed: { en: 'Archidekt did not answer', es: 'Archidekt no respondió', fr: 'Archidekt n’a pas répondu', ar: 'لم يستجب Archidekt' },
  brSearching: { en: 'Searching…', es: 'Buscando…', fr: 'Recherche…', ar: 'جارٍ البحث…' },
  brByAuthor: { en: 'by', es: 'de', fr: 'par', ar: 'بواسطة' },
  brPastedDeck: { en: 'Pasted deck', es: 'Mazo pegado', fr: 'Deck collé', ar: 'مجموعة ملصقة' },
  brPastedHint: { en: 'Preview or add to fetch this deck', es: 'Previsualiza o añade para obtener este mazo', fr: 'Prévisualisez ou ajoutez pour charger ce deck', ar: 'عاين أو أضف لجلب هذه المجموعة' },
  brFetchFailed: { en: 'Could not fetch that decklist', es: 'No se pudo obtener esa lista', fr: 'Impossible de charger cette liste', ar: 'تعذر جلب قائمة المجموعة' },
  brPrevPage: { en: 'Previous', es: 'Anterior', fr: 'Précédent', ar: 'السابق' },
  brNextPage: { en: 'Next', es: 'Siguiente', fr: 'Suivant', ar: 'التالي' },
  ...
  preLeave: { en: 'Leave table', es: 'Salir de la mesa', fr: 'Quitter la table', ar: 'مغادرة الطاولة' },
  preLeaveHost: { en: 'Leave table', es: 'Salir de la mesa', fr: 'Quitter la table', ar: 'مغادرة الطاولة' },
  preStay: { en: 'Stay', es: 'Quedarse', fr: 'Rester', ar: 'البقاء' },
  preLeaveTitle: { en: 'Leave this table?', es: '¿Salir de esta mesa?', fr: 'Quitter cette table ?', ar: 'مغادرة هذه الطاولة؟' },
  preLeaveBody: {
    en: 'Your seat opens up. The table stays for everyone else, and you can rejoin from the same link.',
    es: 'Tu asiento queda libre. La mesa sigue para los demás y puedes volver con el mismo enlace.',
    fr: 'Votre siège se libère. La table reste pour les autres et vous pouvez revenir avec le même lien.',
    ar: 'سيصبح مقعدك شاغرًا. تبقى الطاولة للآخرين ويمكنك العودة بالرابط نفسه.',
  },
  preCloseTable: { en: 'Close table', es: 'Cerrar mesa', fr: 'Fermer la table', ar: 'إغلاق الطاولة' },
  preCloseTitle: { en: 'Close this table for everyone?', es: '¿Cerrar la mesa para todos?', fr: 'Fermer la table pour tout le monde ?', ar: 'إغلاق الطاولة للجميع؟' },
  preCloseBody: {
    en: 'The table is deleted and every seat is sent back to the lobby. Use this when a game can never start.',
    es: 'La mesa se elimina y todos vuelven al vestíbulo. Úsalo cuando una partida no pueda empezar.',
    fr: 'La table est supprimée et chaque siège retourne au salon. À utiliser quand une partie ne peut pas démarrer.',
    ar: 'تُحذف الطاولة ويعود كل مقعد إلى الردهة. استخدم هذا عندما يتعذّر بدء المباراة.',
  },
  preRemovePlayer: { en: 'Remove from the table', es: 'Quitar de la mesa', fr: 'Retirer de la table', ar: 'إزالة من الطاولة' },
  gpLoyalty: { en: 'Loyalty', es: 'Lealtad', fr: 'Loyauté', ar: 'الولاء' },
  gpLoyaltyHint: {
    en: 'Loyalty — click for this planeswalker’s abilities',
    es: 'Lealtad: haz clic para ver las habilidades de este planeswalker',
    fr: 'Loyauté — cliquez pour les capacités de ce planeswalker',
    ar: 'الولاء — انقر لعرض قدرات هذا البلانزووكر',
  },
  gpLoyaltyAbilities: { en: 'Abilities', es: 'Habilidades', fr: 'Capacités', ar: 'القدرات' },
  gpLoyaltyAdjust: { en: 'Adjust', es: 'Ajustar', fr: 'Ajuster', ar: 'تعديل' },
  gpLoyaltyPlusOne: { en: 'Add a loyalty', es: 'Añadir lealtad', fr: 'Ajouter de la loyauté', ar: 'أضف ولاءً' },
  gpLoyaltyMinusOne: { en: 'Remove a loyalty', es: 'Quitar lealtad', fr: 'Retirer de la loyauté', ar: 'أزل ولاءً' },
  ...
  setAutoCounters: {
    en: 'Add +1/+1 counters without asking',
    es: 'Añadir contadores +1/+1 sin preguntar',
    fr: 'Ajouter les marqueurs +1/+1 sans demander',
    ar: 'أضف عدادات +1/+1 دون سؤال',
  },
  gpCountersOne: {
    en: 'Add {n} to {card}?',
    es: '¿Añadir {n} a {card}?',
  ...
  gpCountersMany: {
    en: 'Add {n} to {count} creatures?',
    es: '¿Añadir {n} a {count} criaturas?',
    fr: 'Ajouter {n} à {count} créatures ?',
    ar: 'إضافة {n} إلى {count} مخلوقات؟',
  },
  gpCountersUnit: {
    en: 'a +1/+1 counter',
    es: 'un contador +1/+1',
  ...
  setQuickplay: { en: 'Quickplay', es: 'Partida rápida', fr: 'Partie rapide', ar: 'لعب سريع' },
  setQuickplayHint: {
    en: 'Nobody brings a deck. Every seat is dealt a random precon on arrival and can reroll it three times before the game starts.',
    es: 'Nadie trae mazo. Cada asiento recibe un preconstruido al azar al llegar y puede volver a tirarlo tres veces antes de empezar.',
    fr: 'Personne n\u2019apporte de deck. Chaque siège reçoit un précon au hasard en arrivant et peut le relancer trois fois avant le début.',
    ar: '\u0644\u0627 \u0623\u062d\u062f \u064a\u062d\u0636\u0631 \u0645\u062c\u0645\u0648\u0639\u0629. \u064a\u062d\u0635\u0644 \u0643\u0644 \u0645\u0642\u0639\u062f \u0639\u0644\u0649 \u0645\u062c\u0645\u0648\u0639\u0629 \u062c\u0627\u0647\u0632\u0629 \u0639\u0634\u0648\u0627\u0626\u064a\u0629 \u0639\u0646\u062f \u0648\u0635\u0648\u0644\u0647\u060c \u0648\u064a\u0645\u0643\u0646\u0647 \u0625\u0639\u0627\u062f\u0629 \u0627\u0644\u0631\u0645\u064a \u062b\u0644\u0627\u062b \u0645\u0631\u0627\u062a \u0642\u0628\u0644 \u0627\u0644\u0628\u062f\u0621.',
  },
  preQuickDeck: { en: 'Your dealt deck', es: 'Tu mazo repartido', fr: 'Votre deck distribué', ar: 'مجموعتك الموزّعة' },
  ...
  tickerOpen: {
    ...
    ar: 'قراءة ملاحظات الإصدار',
  },
  rlVsFriends: { en: 'Friends', es: 'Amigos', fr: 'Amis', ar: 'أصدقاء' },
  rlVsAi: { en: 'AI', es: 'IA', fr: 'IA', ar: 'ذكاء اصطناعي' },
  ...
  gpCountersAlwaysHint: {
    ...
    es: 'Añadirlos a partir de ahora sin preguntar',
    fr: 'Les ajouter désormais sans demander',
    ar: 'أضفها من الآن دون سؤال',
  },
  ...
  emWow: { en: 'Wow!', es: '¡Guau!', fr: 'Waouh !', ar: 'واو!' },
  ...
  // versus stage
  preVs: { en: 'vs', es: 'vs', fr: 'vs', ar: 'ضد' },
  preOpponent: { en: 'Opponent', es: 'Oponente', fr: 'Adversaire', ar: 'الخصم' },
  preOpponents: { en: 'Opponents', es: 'Oponentes', fr: 'Adversaires', ar: 'الخصوم' },
  preReadyCount: { en: 'ready', es: 'listos', fr: 'prêts', ar: 'جاهزون' },
  preNobodyYet: {
    en: 'Nobody else has sat down yet',
    es: 'Nadie más se ha sentado todavía',
    fr: 'Personne d’autre ne s’est encore assis',
    ar: 'لم يجلس أحد آخر بعد',
  },
  preScouting: {
    en: 'Scouting report',
    es: 'Informe del jugador',
    fr: 'Fiche du joueur',
    ar: 'تقرير عن اللاعب',
  },
  preSeatDetails: {
    en: 'Seat details',
    es: 'Detalles del asiento',
    fr: 'Détails de la place',
    ar: 'تفاصيل المقعد',
  },
  preFillSeat: { en: 'Fill this seat', es: 'Ocupar este asiento', fr: 'Occuper cette place', ar: 'اشغل هذا المقعد' },
  preInviteLink: {
    en: 'Invite by link',
    es: 'Invitar con enlace',
    fr: 'Inviter par lien',
    ar: 'دعوة عبر رابط',
  },
  ...
  gpSelected: { en: 'selected', es: 'seleccionadas', fr: 'sélectionnées', ar: 'محددة' },
  gpSelTap: { en: 'Tap / untap', es: 'Girar / enderezar', fr: 'Engager / dégager', ar: 'إدارة / فرد' },
  gpSelClear: { en: 'Clear', es: 'Limpiar', fr: 'Effacer', ar: 'مسح' },
  ...
  logCollapse: { en: 'Hide the log', es: 'Ocultar el registro', fr: 'Masquer le journal', ar: 'إخفاء السجل' },
  logShowNames: { en: 'Reveal card names', es: 'Revelar nombres de cartas', fr: 'Révéler les noms des cartes', ar: 'كشف أسماء البطاقات' },
  logHideNames: { en: 'Star out card names', es: 'Ocultar nombres con estrellas', fr: 'Masquer les noms', ar: 'إخفاء الأسماء بالنجوم' },
  libSearchPh: { en: 'Search name or type…', es: 'Buscar nombre o tipo…', fr: 'Nom ou type…', ar: 'ابحث بالاسم أو النوع…' },
  libSortLabel: { en: 'Sort library', es: 'Ordenar biblioteca', fr: 'Trier la bibliothèque', ar: 'فرز المكتبة' },
  libSortOrder: { en: 'Library order', es: 'Orden de biblioteca', fr: 'Ordre de la bibliothèque', ar: 'ترتيب المكتبة' },
  libSortName: { en: 'By name', es: 'Por nombre', fr: 'Par nom', ar: 'بالاسم' },
  libSortMv: { en: 'By mana value', es: 'Por coste de maná', fr: 'Par coût de mana', ar: 'بقيمة المانا' },
  libSortType: { en: 'By type', es: 'Por tipo', fr: 'Par type', ar: 'بالنوع' },
  spMatch: { en: 'Match', es: 'Partida', fr: 'Partie', ar: 'المباراة' },
  cmdPassTurn: { en: 'Pass the turn', es: 'Pasar el turno', fr: 'Passer le tour', ar: 'تمرير الدور' },
  cmdAttack: { en: 'Begin combat', es: 'Iniciar combate', fr: 'Commencer le combat', ar: 'بدء القتال' },
  cmdEndCombat: { en: 'End combat', es: 'Terminar combate', fr: 'Terminer le combat', ar: 'إنهاء القتال' },
  cmdDraw: { en: 'Draw a card', es: 'Robar una carta', fr: 'Piocher une carte', ar: 'سحب بطاقة' },
  cmdUntap: { en: 'Untap all', es: 'Enderezar todo', fr: 'Tout dégager', ar: 'فك الجميع' },
  cmdShuffle: { en: 'Shuffle library', es: 'Barajar biblioteca', fr: 'Mélanger la bibliothèque', ar: 'خلط المكتبة' },
  cmdSearchLib: { en: 'Search library', es: 'Buscar en biblioteca', fr: 'Chercher dans la bibliothèque', ar: 'البحث في المكتبة' },
  cmdRevealHand: { en: 'Reveal hand', es: 'Revelar mano', fr: 'Révéler la main', ar: 'كشف اليد' },
  cmdRollD20: { en: 'Roll a d20', es: 'Tirar un d20', fr: 'Lancer un d20', ar: 'رمي d20' },
  cmdRollD6: { en: 'Roll a d6', es: 'Tirar un d6', fr: 'Lancer un d6', ar: 'رمي d6' },
  cmdCoin: { en: 'Flip a coin', es: 'Lanzar moneda', fr: 'Pile ou face', ar: 'رمي عملة' },
  cmdLifeUp: { en: 'Life +1', es: 'Vida +1', fr: 'Vie +1', ar: 'حياة +1' },
  cmdLifeDown: { en: 'Life -1', es: 'Vida -1', fr: 'Vie -1', ar: 'حياة -1' },
  cmdChat: { en: 'Open chat', es: 'Abrir chat', fr: 'Ouvrir le chat', ar: 'فتح الدردشة' },
  cmdConcede: { en: 'Concede the match', es: 'Conceder la partida', fr: 'Concéder la partie', ar: 'التنازل عن المباراة' },
  ...
  tgTitle: { en: 'Choose a target', es: 'Elige un objetivo', fr: 'Choisir une cible', ar: 'اختر هدفًا' },
  tgNoTarget: { en: 'No target', es: 'Sin objetivo', fr: 'Aucune cible', ar: 'بدون هدف' },
  tgNone: { en: 'Nothing on the table matches this spell.', es: 'Nada en la mesa coincide con este hechizo.', fr: 'Rien sur la table ne correspond à ce sort.', ar: 'لا شيء على الطاولة يطابق هذه التعويذة.' },
  tgCreature: { en: 'Creature', es: 'Criatura', fr: 'Créature', ar: 'مخلوق' },
  tgPlaneswalker: { en: 'Planeswalker', es: 'Planeswalker', fr: 'Planeswalker', ar: 'بلانزواكر' },
  tgArtifact: { en: 'Artifact', es: 'Artefacto', fr: 'Artefact', ar: 'قطعة أثرية' },
  tgEnchantment: { en: 'Enchantment', es: 'Encantamiento', fr: 'Enchantement', ar: 'سحر' },
  tgLand: { en: 'Land', es: 'Tierra', fr: 'Terrain', ar: 'أرض' },
  tgPermanent: { en: 'Permanent', es: 'Permanente', fr: 'Permanent', ar: 'دائم' },
  tgPlayer: { en: 'Player', es: 'Jugador', fr: 'Joueur', ar: 'لاعب' },
  tgOpponent: { en: 'Opponent', es: 'Oponente', fr: 'Adversaire', ar: 'خصم' },
  tgSpell: { en: 'Spell', es: 'Hechizo', fr: 'Sort', ar: 'تعويذة' },
  tgAny: { en: 'Any target', es: 'Cualquier objetivo', fr: 'N’importe quelle cible', ar: 'أي هدف' },
  // Deck stats hover.
  dsCards: { en: 'cards', es: 'cartas', fr: 'cartes', ar: 'بطاقات' },
  dsCurve: { en: 'Mana curve', es: 'Curva de maná', fr: 'Courbe de mana', ar: 'منحنى المانا' },
  dsOther: { en: 'other', es: 'otros', fr: 'autres', ar: 'أخرى' },
  ...
  abTitle: { en: 'Abilities', es: 'Habilidades', fr: 'Capacités', ar: 'القدرات' },
  ...
  rlLede: {
    en: 'Bring nothing. The table deals everyone a random deck and starts.',
    es: 'No traigas nada. La mesa reparte un mazo al azar a cada uno y empieza.',
    fr: 'N’apportez rien. La table distribue un deck au hasard à chacun et lance la partie.',
    ar: 'لا تُحضر شيئًا. توزّع الطاولة مجموعة عشوائية على الجميع وتبدأ.',
  },
  hqCustom: { en: 'Custom table', es: 'Mesa personalizada', fr: 'Table personnalisée', ar: 'طاولة مخصصة' },
  hqCustomSub: {
    en: 'Pick the format, seats and rules yourself',
    es: 'Elige el formato, los asientos y las reglas',
    fr: 'Choisissez le format, les sièges et les règles',
    ar: 'اختر الصيغة والمقاعد والقواعد بنفسك',
  },
  hmPlayNow: { en: 'Play now', es: 'Jugar ya', fr: 'Jouer maintenant', ar: 'العب الآن' },
  hqCmdRouletteSub: {
    en: 'Bring nothing - five seats, five dealt precons',
    es: 'No traigas nada: cinco asientos, cinco preconstruidos al azar',
    fr: 'N’apportez rien - cinq sièges, cinq précons distribués',
    ar: 'لا تُحضر شيئًا - خمسة مقاعد، خمس مجموعات جاهزة موزّعة',
  },
  hqStandard: { en: 'Standard', es: 'Estándar', fr: 'Standard', ar: 'ستاندرد' },
  hqStandardSub: {
    en: 'A 60-card duel against the house',
    es: 'Un duelo de 60 cartas contra la casa',
    fr: 'Un duel à 60 cartes contre la maison',
    ar: 'مبارزة من ٦٠ بطاقة ضد البيت',
  },
  hqCommander: { en: 'Commander', es: 'Commander', fr: 'Commander', ar: 'كوماندر' },
  hqCommanderSub: {
    en: 'A four-seat pod, your deck against three',
    es: 'Una mesa de cuatro, tu mazo contra tres',
    fr: 'Une table de quatre, votre deck contre trois',
    ar: 'طاولة من أربعة، مجموعتك ضد ثلاث',
  },
  hqRouletteSub: {
    en: 'Bring nothing - the table deals both decks',
    es: 'No traigas nada: la mesa reparte ambos mazos',
    fr: 'N’apportez rien - la table distribue les deux decks',
    ar: 'لا تُحضر شيئًا - الطاولة توزّع المجموعتين',
  },
  rlStandardTitle: {
    en: 'Standard Roulette',
    es: 'Ruleta Estándar',
    fr: 'Roulette Standard',
    ar: 'روليت ستاندرد',
  },
  rlStandardBlurb: {
    en: 'A 60-card duel against the house, both decks drawn at random.',
    es: 'Un duelo de 60 cartas contra la casa, ambos mazos al azar.',
    fr: 'Un duel à 60 cartes contre la maison, les deux decks tirés au hasard.',
    ar: 'مبارزة من ٦٠ بطاقة ضد البيت، كلا المجموعتين بالقرعة.',
  },
  rlCommanderTitle: {
    en: 'Commander Roulette',
    es: 'Ruleta Commander',
    fr: 'Roulette Commander',
    ar: 'روليت كوماندر',
  },
  rlCommanderBlurb: {
    en: 'A five-seat pod, every seat dealt a random precon.',
    es: 'Una mesa de cinco, cada asiento recibe un precon al azar.',
    fr: 'Une table de cinq, chaque siège reçoit un precon au hasard.',
    ar: 'طاولة من خمسة، كل مقعد يتلقى مجموعة جاهزة عشوائية.',
  },
  rlDealing: {
    en: 'Dealing…',
    es: 'Repartiendo…',
  ...
  rlFailed: {
    en: 'Could not open the table',
    es: 'No se pudo abrir la mesa',
    fr: 'Impossible d’ouvrir la table',
    ar: 'تعذّر فتح الطاولة',
  },
  plQuickTitle: {
    en: 'Quick start',
    es: 'Inicio rápido',
  ...
  lbSub: {
    en: 'Every game against another player counts. Bot practice never moves it.',
    es: 'Cuenta cada partida contra otro jugador. La práctica con bots nunca la mueve.',
    fr: 'Chaque partie contre un autre joueur compte. Les parties contre des bots ne comptent jamais.',
    ar: 'كل مباراة ضد لاعب آخر تُحتسب. اللعب ضد الروبوتات لا يُحرّكها أبدًا.',
  },
  ...
  lbTopRank: {
    en: 'Top of the ladder - nothing above this',
    es: 'Cima de la clasificación: nada por encima',
    fr: 'Sommet du classement - rien au-dessus',
    ar: 'قمة السلم - لا شيء فوق هذا',
  },
  lbBehind: {
    en: 'behind',
    es: 'por detrás de',
