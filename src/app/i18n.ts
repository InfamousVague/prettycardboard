...
export const messages = {
  ...
  setSounds: { en: 'Table sounds', es: 'Sonidos de la mesa', fr: 'Sons de table', ar: 'أصوات الطاولة' },
  setSoundsHint: {
    en: 'Turn alerts, pings, cards, shuffling, and dice. Interface buttons stay quiet.',
    es: 'Alertas de turno, avisos, cartas, barajado y dados. Los botones de la interfaz permanecen silenciosos.',
    fr: 'Alertes de tour, rappels, cartes, mélange et dés. Les boutons de l’interface restent silencieux.',
    ar: 'تنبيهات الدور والإشارات والبطاقات والخلط والنرد. تبقى أزرار الواجهة صامتة.',
  },
