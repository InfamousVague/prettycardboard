                ...
                >
                  ...
                  {player.userId === identity?.userId && me && !spectating && room.started ? (
                    ...
                    <div className="playerGridPreview">
                      {/* The grid seats opponents on the row above mine, i.e.
                          literally across the table, so their board faces me
                          regardless of the mirror preference. */}
                      <SeatFrame room={room} player={player} me={me} canAct={canAct} onHover={handleHover} stage mirror />
                    </div>
                  )}
                </div>
              ))}
